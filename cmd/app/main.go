...
func setupMux() *http.ServeMux {
	...
	mux.HandleFunc("/error", handlers.ForceDirectError) // !pour les tests uniquement (pas pour la production)
	mux.HandleFunc("/500", handlers.Force500Handler)    // !pour les tests uniquement (pas pour la production)
